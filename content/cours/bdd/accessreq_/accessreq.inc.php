 ...
 * @uses
 */
$sNavigation=navigation('access', '1', 'req');
$sNavigation;
...
<h1>ACCESS : Réponses des requêtes</h1>
...
<ol class="instruction">
	<li>Assurez-vous  d'avoir la requête de type sélection <img src="/assets/img/access/bouton_requete_selection.png" alt="bouton requête sélection" />.</li>
</ol>
<ul>
...
<pre>Vous n'êtes pas obligé de mettre les guillemets (Access  va les mettre pour indiquer que le champ est de type &quot;texte&quot;)
 ni de  mettre l'opérateur &quot; = &quot; (Il est mis par défaut si aucun autre  opérateur n'est choisi).</pre>
<pre>Vous n'êtes pas obligé de mettre le texte en majuscules  ou en minuscules. Access ne fait pas la différence lors de la
 recherche. Il  faut cependant écrire le critère correctement. 
 Par exemple, vous ne trouverez  personne si vous avez écrit &quot;gerant&quot; !</pre>
<pre>Pour les champs de type Date/Heure, Access placera automatiquement devant et après la date le caractère &quot; # &quot;. 
