<?php
/**
 * page de cours 11 sur ACCESS 2003 : Exercices
 *
...
<ol class="instruction">
	<li>Entrez le nom du premier champ : <strong>Nom de l'entreprise,</strong> dans la case du coin supérieur gauche.</li>
</ol>
...
<ol class="instruction">
	<li>Entrez la description à la case de champ. Vous verrez au bas de l'écran les propriétés du champ.</li>
</ol>
<p class="notice remarque">Le taille du champ est important. Il faut que la taille soit assez grand pour entrer les données mais pas trop pour avoir de l'espace inutile. La taille des disques durs a beaucoup évoluée depuis les dernières années. Mais un bon concepteur de base de données n'aime pas perdre de la place inutilement. Il préfère que l'espace soit utilisé pour des données qui sont utiles pour l'entreprise.</p>
<ol class="instruction">
	<li>Entrer des champs : Tableau avec la liste des champs.</li>
	<li>Ajoutez la clé primaire pour le champ.</li>
	<li>Entrez de quelques données : Désirée DERATA et fils.</li>
</ol>

<h4>Création d'un formulaire</h4>
<p>Il est plus facile pour un utilisateur de saisir les données sous forme de formulaire que dans un tableau. Le nom de certain des champs ne pourrait pas lui donner assez d'informations. Il est possible qu'un utilisateur n'ai pas besoin de voir tout les champs.</p>
<p class="notice exemple">Ex : est-ce qu'un employé à besoin de voir le salaire de tous les employés ? Il peut n'avoir besoin que d'ajouter des personnes ou changer leur adresse ou privilège.</p>
<p>Un formulaire est plus convivial pour saisir de l'information qu'un tableau,&nbsp; d'autant plus que les champs requis et les données peuvent provenir de plusieurs tables ou requêtes.</p>
...
<ol class="instruction">
    ...
    <h3>Exercice 2: Création d'un formulaire de facturation</h3>
<ol class="instruction">
	<li>Création de requêtes basé sur plusieurs tables ou requêtes.</li>
