 ...
 * @uses
 */
$sNavigation = navigation('sae', '403mtd', '4mtdstage', '402mtd');
$tdm = tdm('sae400');
echo $tdm;
?>
...
<ul>
    ...
    <li>Identifier des fonctionnalités d’un SI spécifique et la valeur ajoutée apportée par ce SI.</li>
</ul>
<p>Le projet sera structuré en suivant une démarche d’amélioration.</p>

<h2>Descriptif générique :</h2>

<p>L’étudiant devra améliorer un processus de réalisation déjà formalisé et réaliste, en suivant une démarche structurée. Cette SAÉ s’appuie sur une production stabilisée.</p>
...
<p>À partir des fonctionnalités d’un ou plusieurs SI spécifiques :</p>
<ul>
    <li>Identifier les données nécessaires à ces fonctionnalités.</li>
    <li>Identifier la ou les fonctionnalités du SI concerné et la valeur ajoutée apportée par le SI.</li>
</ul>
