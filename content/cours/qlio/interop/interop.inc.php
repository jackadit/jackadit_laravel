 ...
 * @uses
 */
$sNavigation = navigation('interop', '0'); ?>
<aside>
	<p class="h2-like">Table des matières</p>
	<ol class="unstyled">
		<li><a href="/cours/qlio/interop/1" title="cours1" id="tdmintro">Interopérabilité des systèmes</a></li>
		<li><a href="/cours/qlio/interop/2" title="cours2">Modèle d’architecture en couches</a></li>
		<li><a href="/cours/qlio/interop/3" title="cours3">Modèle d’architecture orientée services SOA</a></li>
        <li><a href="/cours/qlio/interop/4" title="cours4">Modèle d’architecture orientée données DOA</a></li>
        <li><a href="/cours/qlio/interop/5" title="cours5">Modèle d’architecture ESB</a></li>
        <li><a href="/cours/qlio/interop/6" title="cours6">Protocole d'échanges de données</a></li>
        <li><a href="/cours/qlio/interop/7" title="cours7">Langages et format d’échanges</a></li>
        <li><a href="/cours/qlio/interop/8" title="cours8">Hygiène numérique</a></li>
	</ol>
</aside>
