...
<p class="h2-like">Table des matières</p>
	<ol id="gpstock" class="unstyled">
		<li><a href="/cours/qlio/gstock/1" title="cours 1" id="gstock1">Le dilemme stocks / délai</a></li>
		<li><a href="/cours/qlio/gstock/2" title="cours 2" id="gstock2">Coûts et indicateurs de stocks</a></li>
		<li><a href="/cours/qlio/gstock/3" title="cours 3" id="gstock3">Classification ABC</a></li>
		<li><a href="/cours/qlio/gstock/4" title="cours 4" id="gstock4">Combien commander ?</a></li>
		<li><a href="/cours/qlio/gstock/5" title="cours 5" id="gstock5">Quand commander ?</a></li>
		<li><a href="/cours/qlio/gstock/6" title="cours 6" id="gstock6">Stock de sécurité</a></li>
		<li><a href="/cours/qlio/gstock/7" title="cours 7" id="gstock7">Les stocks dans la Supply Chain</a></li>
		<li><a href="/cours/qlio/gstock/8" title="cours 8" id="gstock8">La Supply Chain dans l'entreprise</a></li>
    </ol>
</aside>
...
<p>Acquérir les bases théoriques nécessaires pour comprendre la gestion des stocks, identifier les fonctions et
 ...
 <p>Comprendre les méthodes de gestion classiques : point de commande, calcul du besoin net (<strong>CBN</strong> ou en anglais <strong>MRP</strong> : Material Requirements Planning)</p>
 <p>Déterminer les paramètres de gestion à utiliser dans les différents cas de stock</p>

<h1>Introduction à la gestion de stock</h1>
...
<ul>
<li><i><strong>Méthode de réapprovisionnement ou méthode calendaire</strong></i>. On commande à date fixe une quantité fixe voisine de la quantité économique de commande (QEC ou <a rel="nofollow" class="external" target="_blank" hreflang="fr" href="https://fr.wikipedia.org/wiki/Formule_de_Wilson" title="Formule de Wilson">Formule de Wilson</a>).</li>
<li><i><strong>Méthode de gestion à Point de commande</strong></i>. C'est un modèle de commande à date variable et à quantité fixe. Lorsque l'on atteint un certain niveau de stock, le "point de commande", on déclenche la commande de réapprovisionnement.</li>
<li><i><strong>Méthode de recomplètement</strong></i>. A date fixe, la quantité variable permettant de reconstituer le niveau de stock défini est commandée.</li>
<li><i><strong>Méthode de réapprovisionnement à la commande</strong></i>. A date variable, une quantité variable est commandée.</li>
</ul>


<p>Leur but étant de supprimer les goulets d'étranglement dans le flux de gestion des biens. La méthode de juste à temps (JAT) par exemple partage cet objectif.</p>
