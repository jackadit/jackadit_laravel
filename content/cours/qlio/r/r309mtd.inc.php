 ...
 * @uses
 */
$sNavigation = navigation('r', '309mtd', '310mtd', '308mtd');
$tdm = tdm('r300mtd');
echo $tdm;
?>
...
<h2>Apprentissages critiques ciblés :</h2>
<ul>
    <li>AC22.01 | Paramétrer les stocks.</li>
    <li>AC22.02 | Contrôler et valider des données générées par le système d’information.</li>
</ul>
<h2>Mots clés :</h2>
